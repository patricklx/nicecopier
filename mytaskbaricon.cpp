...
MyTaskBarIcon::MyTaskBarIcon(QWidget *_parent,bool hideIcon)
	:QSystemTrayIcon(QIcon(":/icons/Copy2.ico"),_parent),menu(_parent), hideIcon(hideIcon)
{
